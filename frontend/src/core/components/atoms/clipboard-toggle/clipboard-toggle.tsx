...
import styles from '@components/atoms/clipboard-toggle/custom-clipboard-toggle.module.css'
...
const ClipboardToggle: React.FC<ClipboardToggleProps> = ({ checked, onChange }) => {
  return (
    <label className={styles.container}>
      <input type="checkbox" checked={checked} onChange={onChange} />
      <svg viewBox="0 0 384 512" height="1em" xmlns="http://www.w3.org/2000/svg" className={styles.clipboard}>
      ...
      <svg viewBox="0 0 384 512" height="1em" xmlns="http://www.w3.org/2000/svg" className={styles.clipboardCheck}>
