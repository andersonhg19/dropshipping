...
async function GetAllCategory(ae_object: Record<string, any>): Promise<GenericPageResponse> {
  try {
    ...
    const data = await RawFetchData<GenericPageResponse>(BASE_URL_COMMERCE_CATEGORY, 'all', options)
