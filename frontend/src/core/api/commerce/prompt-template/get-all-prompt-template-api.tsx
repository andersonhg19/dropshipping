...
import { BASE_URL_COMMERCE_PROMPT_TEMPLATE } from '@api/api-path'
import { RawFetchData } from '@api/raw-fetch-data'
import { GenericPageResponse } from '@api/generic-response'

export async function GetAllPromptTemplate(filter: any): Promise<GenericPageResponse> {
  ...
  return RawFetchData<GenericPageResponse>(BASE_URL_COMMERCE_PROMPT_TEMPLATE, 'all', options)
}
