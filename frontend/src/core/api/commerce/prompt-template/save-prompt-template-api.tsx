...
export async function SavePromptTemplateApi(data: any): Promise<GenericSaveResponse> {
  ...
  return RawFetchData<GenericSaveResponse>(BASE_URL_COMMERCE_PROMPT_TEMPLATE, 'save', options)
}
