...
async function GetAllPricingConfig(ae_object: Record<string, any>): Promise<GenericPageResponse> {
  try {
    ...
    const data = await RawFetchData<GenericPageResponse>(BASE_URL_COMMERCE_PRICING_CONFIG, 'all', options)
