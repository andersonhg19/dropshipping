...
async function GetAllPublishChannel(ae_object: Record<string, any>): Promise<GenericPageResponse> {
  try {
    ...
    const data = await RawFetchData<GenericPageResponse>(BASE_URL_COMMERCE_PUBLISH_CHANNEL, 'all', options)
