...
export async function GetAllEnrichmentConfig(filter: any): Promise<GenericPageResponse> {
  ...
  return RawFetchData<GenericPageResponse>(BASE_URL_COMMERCE_ENRICHMENT_CONFIG, 'all', options)
}
