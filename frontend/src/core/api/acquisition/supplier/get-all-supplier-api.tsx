...
async function GetAllSupplier(ae_object: Record<string, any>): Promise<GenericPageResponse> {
  try {
    ...
    const data = await RawFetchData<GenericPageResponse>(BASE_URL_ACQUISITION_SUPPLIER, 'all', options)
