 ...
 * de 2012 exige política de tratamiento de datos personales.
 *
 ...
 * rellenar (NIT, dirección, teléfono).
 *
...
<p>En {{RAZON_SOCIAL}} (NIT {{NIT}}), responsable del tratamiento de datos, protegemos tu información personal conforme a la <strong>Ley 1581 de 2012</strong> y el <strong>Decreto 1074 de 2015</strong>.</p>

<h2>1. Que datos recogemos</h2>
<ul>
<li><strong>Identificacion y contacto:</strong> nombre, celular, correo electronico y dirección de entrega.</li>
<li><strong>Datos del pedido:</strong> productos, monto, medio de pago y estado del envio.</li>
<li><strong>Datos tecnicos:</strong> dirección IP, navegador y paginas visitadas, a traves de cookies.</li>
</ul>
...
<li>Contactarte por WhatsApp o teléfono para confirmar la entrega.</li>
...
<ul>
<li><strong>Transportadoras:</strong> nombre, dirección y celular, para poder entregarte.</li>
...
<p><strong>Como ejercer tus derechos:</strong> escribenos a {{EMAIL}} o al {{TELEFONO}} indicando tu nombre, el documento y tu solicitud. Respondemos consultas en maximo <strong>10 dias hábiles</strong> y reclamos en maximo <strong>15 dias hábiles</strong>, según la ley.</p>
</div>
...
<p>Estos términos rigen las compras en {{SITIO}}, operado por {{RAZON_SOCIAL}} (NIT {{NIT}}). Al hacer un pedido aceptas lo aquí descrito.</p>
...
<li>Las fotografias son ilustrativas. Puede haber variaciones leves de color según la pantalla.</li>
<li>Los precios pueden cambiar sin aviso previo, pero <strong>nunca después de que confirmemos tu pedido</strong>.</li>
...
<p>Tu pedido es una oferta de compra. La venta queda perfeccionada cuando <strong>te confirmamos el pedido</strong> por WhatsApp, teléfono o correo. Hasta ese momento cualquiera de las dos partes puede desistir sin penalidad.</p>
...
<tr><td>Tarjeta débito o crédito</td><td>Al confirmar la compra</td></tr>
...
<h2>4. Envíos</h2>
<p>Ver la <a href="' . home_url('/política-de-envíos/') . '">Política de Envíos</a>.</p>

<h2>5. Derecho de retracto</h2>
<div class="vn-legal__callout">
<p>Conforme al <strong>artículo 47 de la Ley 1480 de 2011</strong>, tienes derecho a retractarte de la compra dentro de los <strong>cinco (5) dias hábiles</strong> siguientes a la entrega, sin necesidad de justificar el motivo. Ver la <a href="' . home_url('/política-de-devoluciones/') . '">Política de Devoluciones</a>.</p>
</div>

<h2>6. Garantia</h2>
<p>Todos los productos cuentan con la <strong>garantia legal</strong> del artículo 7 de la Ley 1480 de 2011 frente a defectos de fabricacion o calidad. El plazo minimo es de tres (3) meses desde la entrega, salvo que el fabricante ofrezca uno mayor.</p>
...
<p>Estos términos se rigen por la ley colombiana. Cualquier controversia se tramitara ante los jueces competentes de {{CIUDAD}}, sin perjuicio de tu derecho a acudir a la Superintendencia de Industria y Comercio.</p>
...
<h2>1. Derecho de retracto: 5 dias hábiles</h2>
<div class="vn-legal__callout">
<p>Si compraste a distancia (por esta tienda), el <strong>artículo 47 de la Ley 1480 de 2011</strong> te da derecho a retractarte dentro de los <strong>cinco (5) dias hábiles</strong> siguientes a la entrega. <strong>No tienes que explicar por que.</strong></p>
</div>

<h3>Que necesitas para el retracto</h3>
<ul>
<li>Que el producto no haya sido usado y conserve sus etiquetas y empaque original.</li>
<li>Avisarnos dentro de los 5 dias hábiles al {{TELEFONO}} o a {{EMAIL}}.</li>
</ul>
...
<tbody>
<tr><td>1</td><td>Escribenos al {{TELEFONO}} (WhatsApp) o a {{EMAIL}} con tu número de pedido.</td></tr>
<tr><td>2</td><td>Te confirmamos la solicitud y te indicamos la dirección de retorno.</td></tr>
<tr><td>3</td><td>Envias el producto en su empaque original.</td></tr>
<tr><td>4</td><td>Al recibirlo y verificarlo, procesamos el cambio o la devolución del dinero.</td></tr>
</tbody>
</table>
...
<tbody>
<tr><td>Bogota y area metropolitana</td><td>1 a 2 dias hábiles</td></tr>
<tr><td>Ciudades principales</td><td>2 a 3 dias hábiles</td></tr>
<tr><td>Ciudades intermedias</td><td>3 a 5 dias hábiles</td></tr>
<tr><td>Zonas rurales y de dificil acceso</td><td>5 a 8 dias hábiles</td></tr>
</tbody>
</table>
...
<ul>
<li><strong>Envío gratis</strong> en pedidos iguales o superiores a $150.000 COP.</li>
<li>Por debajo de ese monto, el costo se calcula según el destino y se muestra antes de confirmar la compra.</li>
</ul>
...
<p><strong>Importante:</strong> te contactamos por WhatsApp o teléfono para confirmar el pedido antes de despacharlo. Si no logramos comunicarnos contigo tras varios intentos, el pedido se cancela automaticamente.</p>
</div>

<h2>4. Confirmación y seguimiento</h2>
<p>Una vez despachado te enviamos el número de guía para que sigas tu pedido en la pagina de la transportadora.</p>
...
<p>Te recomendamos revisar el estado del empaque delante del transportador. Si llega visiblemente danado, dejalo constar en la guía o rechaza la entrega y avisanos de inmediato.</p>
...
<tr><th>Dirección</th><td>{{DIRECCION}}, {{CIUDAD}}</td></tr>
...
<p>Si tienes un reclamo sobre un pedido, escribenos indicando tu <strong>número de pedido</strong>. Respondemos en un maximo de 15 dias hábiles, conforme a la ley.</p>
 ...
 * Publicar una política de privacidad con "[COMPLETAR: NIT]" es peor que no
...
add_action('admin_notices', function () {
    ...
    echo '<div class="notice notice-warning"><p><strong>VISNEX:</strong> hay '
        . count($pending) . ' pagina(s) legal(es) con datos por completar (NIT, dirección, teléfono). '
