...
@Getter
@Setter
@Schema(name = "ImportTemplateFilterDTO", description = "DTO used to filter and paginate ImportTemplate records")
public class ImportTemplateFilterDTO {
    ...
    @Schema(description = "Template name (partial match)", example = "CJ")
    private String name;
