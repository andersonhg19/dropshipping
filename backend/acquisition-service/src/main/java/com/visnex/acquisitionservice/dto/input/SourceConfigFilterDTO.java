...
@Getter
@Setter
@Schema(name = "SourceConfigFilterDTO", description = "DTO used to filter and paginate SourceConfig records")
public class SourceConfigFilterDTO {
    ...
    @Schema(description = "Configuration name (partial match)", example = "CJ")
    private String name;
