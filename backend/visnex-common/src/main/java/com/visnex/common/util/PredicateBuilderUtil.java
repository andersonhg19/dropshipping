package com.visnex.common.util;
...
public class PredicateBuilderUtil {
    ...
    public static <T> void addJoinEquals(List<Predicate> predicates, CriteriaBuilder cb, Root<T> root, String joinName, String joinField, Object value) {
        if (value != null) {
            predicates.add(cb.equal(root.join(joinName).get(joinField), value));
        }
    }

    public static <T> void addLeftJoinEquals(List<Predicate> predicates, CriteriaBuilder cb, Root<T> root, String joinName, String joinField, Object value) {
        if (value != null) {
