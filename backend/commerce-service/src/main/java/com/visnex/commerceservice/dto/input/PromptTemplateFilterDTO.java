...
@Getter
@Setter
@Schema(name = "PromptTemplateFilterDTO", description = "DTO used to filter and paginate PromptTemplate records")
public class PromptTemplateFilterDTO {
    ...
    @Schema(description = "Template name (partial match)", example = "SEO")
    private String name;

    @Schema(description = "Template type", example = "FULL_PIPELINE")
    private String type;
