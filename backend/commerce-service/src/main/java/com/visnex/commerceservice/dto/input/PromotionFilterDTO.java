...
@Getter
@Setter
@Schema(name = "PromotionFilterDTO", description = "DTO used to filter and paginate Promotion records")
public class PromotionFilterDTO {
    ...
    @Schema(description = "Promotion name (partial match)", example = "Summer")
    private String name;

    @Schema(description = "Promotion type", example = "PERCENTAGE")
    private String type;

    @Schema(description = "Applies to", example = "ALL")
