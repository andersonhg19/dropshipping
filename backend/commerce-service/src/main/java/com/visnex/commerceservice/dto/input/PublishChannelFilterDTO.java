...
@Getter
@Setter
@Schema(name = "PublishChannelFilterDTO", description = "DTO used to filter and paginate PublishChannel records")
public class PublishChannelFilterDTO {
    ...
    @Schema(description = "Channel name (partial match)", example = "Woo")
    private String name;

    @Schema(description = "Channel type", example = "WOOCOMMERCE")
    private String type;

    @Schema(description = "Channel status", example = "CONNECTED")
    private String status;

    @Schema(description = "Auto sync flag", example = "true")
