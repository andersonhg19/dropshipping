...
@Getter
@Setter
@Schema(name = "CategoryFilterDTO", description = "DTO used to filter and paginate Category records")
public class CategoryFilterDTO {
    ...
    @Schema(description = "Category name (partial match)", example = "Electro")
    private String name;
