...
@Getter
@Setter
@Schema(name = "ProductFilterDTO", description = "DTO used to filter and paginate Product records")
public class ProductFilterDTO {
    ...
    @Schema(description = "Product title (partial match)", example = "earbuds")
