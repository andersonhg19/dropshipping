package com.visnex.exception;

/**
 * The {@code EmailAlreadyExistException} class is an exception that is thrown
 * to indicate
 * that an attempt to create or update a record failed due to the existence of
 * an email address
 ...
 * </p>
 * 
 * @author Victor Espinoza de los Monteros
 * @see Exception
 */
